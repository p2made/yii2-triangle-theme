		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-4 col-md-offset-4">
					...
					<h2 class="text-center">Login to start your session</h2>

					<div class="panel panel-default">
						<div class="panel-body">

							<form id="login-form" name="signup-form" method="post" role="form">
								<div class="form-group has-feedback field-loginform-username required" autofocus="autofocus">
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<button type="submit" name="login-button" class="btn btn-primary btn-block btn-flat">Login</button>
									</div><!-- /.col -->
								</div>
							</form>
