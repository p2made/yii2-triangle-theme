...
<head>
	...
	<title>About Us | P2Triangle</title>
...
<body>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown active"><a href="#">Pages <i class="fa fa-angle-down"></i></a>
							<ul role="menu" class="sub-menu">
								...
								<li><a class="active" href="about2.php">About 2</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 text-center">
					<img src="/images/about-2.png" class="margin-bottom" alt="">
						...
						<div class="item active">
								...
								<div class="team-single-wrapper">
									<div class="team-single">
										<div class="person-thumb">
											<img src="/images/people/1.jpg" class="img-responsive" alt="">
										</div>
							...
							<div class="col-sm-3 col-xs-6">
								<div class="team-single-wrapper">
									<div class="team-single">
										<div class="person-thumb">
											<img src="/images/people/2.jpg" class="img-responsive" alt="">
										</div>
										<div class="social-profile">
											<ul class="nav nav-pills">
												<li><a href="#"><i class="fa fa-facebook"></i></a></li>
							...
							<div class="col-sm-3 col-xs-6">
								<div class="team-single-wrapper">
									<div class="team-single">
										<div class="person-thumb">
											<img src="/images/people/3.jpg" class="img-responsive" alt="">
										</div>
										<div class="social-profile">
											<ul class="nav nav-pills">
												<li><a href="#"><i class="fa fa-facebook"></i></a></li>
						...
						<div class="item">
							<div class="col-sm-3 col-xs-6">
								<div class="team-single-wrapper">
									<div class="team-single">
										<div class="person-thumb">
											<img src="/images/people/4.jpg" class="img-responsive" alt="">
										</div>
										<div class="social-profile">
											<ul class="nav nav-pills">
												<li><a href="#"><i class="fa fa-facebook"></i></a></li>
	...
	<script type="text/javascript" src="//cdn.jsdelivr.net/jquery.countto/0.1.0/jquery.countTo.min.js"></script>
