...
<head>
	...
	<title>Portfolio 3 Columns + Sidebar | P2Triangle</title>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown active"><a href="portfolio-default.php">Portfolio <i class="fa fa-angle-down"></i></a>
							<ul role="menu" class="sub-menu">
								...
								<li><a class="active" href="portfolio-3cr.php">3 Columns + Right Sidebar</a></li>
