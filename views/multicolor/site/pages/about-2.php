		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 text-center">
					<img src="<?= $assetDir ?>/img/aboutus/5.png" class="margin-bottom" alt="">
			...
			<div class="row">
				<div class="about-us">
					<div class="col-sm-7 wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="300ms">
						...
						<div class="row">
							<div class="col-sm-5">
								<img src="<?= $assetDir ?>/img/aboutus/6.png" class="img-responsive" alt="">
							</div>
							<div class="col-sm-7">
						...
						<div class="item active">
								...
								<div class="team-single-wrapper">
									<div class="team-single">
										<div class="person-thumb">
											<img src="<?= $assetDir ?>/img/aboutus/1.jpg" class="img-responsive" alt="">
										</div>
										<div class="social-profile">
											<ul class="nav nav-pills">
												<li><a href="#"><?= FA::i('facebook') ?></a></li>
												<li><a href="#"><?= FA::i('twitter') ?></a></li>
												<li><a href="#"><?= FA::i('google') ?></a></li>
											</ul>
										</div>
									</div>
							...
							<div class="col-sm-3 col-xs-6">
								<div class="team-single-wrapper">
									<div class="team-single">
										<div class="person-thumb">
											<img src="<?= $assetDir ?>/img/aboutus/2.jpg" class="img-responsive" alt="">
										</div>
										<div class="social-profile">
											<ul class="nav nav-pills">
												<li><a href="#"><?= FA::i('facebook') ?></a></li>
							...
							<div class="col-sm-3 col-xs-6">
								<div class="team-single-wrapper">
									<div class="team-single">
										<div class="person-thumb">
											<img src="<?= $assetDir ?>/img/aboutus/3.jpg" class="img-responsive" alt="">
										</div>
										<div class="social-profile">
											<ul class="nav nav-pills">
												<li><a href="#"><?= FA::i('facebook') ?></a></li>
						...
						<div class="item">
							<div class="col-sm-3 col-xs-6">
								<div class="team-single-wrapper">
									<div class="team-single">
										<div class="person-thumb">
											<img src="<?= $assetDir ?>/img/aboutus/4.jpg" class="img-responsive" alt="">
										</div>
										<div class="social-profile">
											<ul class="nav nav-pills">
												<li><a href="#"><?= FA::i('facebook') ?></a></li>
